...
func TestAdminRoutesRejectAnonymous(t *testing.T) {
	...
	cases := []struct {
		...
		{http.MethodPost, "/api/admin/divergences/1/import"},
		{http.MethodPost, "/api/admin/divergences/1/adopt"},
		{http.MethodPost, "/api/admin/divergences/1/mark-deleted"},
		{http.MethodDelete, "/api/admin/divergences/1"},
