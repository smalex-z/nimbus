    ...
    "paths": {
        ...
        "/audit": {
            "get": {
                ...
                "description": "Read-only inspection of the cluster audit log. Newest\nfirst; filterable by actor, action prefix, and time\nrange. Use the prefix form to scope by domain — e.g.\n` + "`" + `action_prefix=vm.` + "`" + ` matches every VM event;\n` + "`" + `action_prefix=settings.` + "`" + ` matches all settings updates.",
                "produces": [
                    "application/json"
                ],
                "tags": [
