    ...
    "paths": {
        ...
        "/proxmox/binding/diagnose": {
            "get": {
                ...
                "description": "Classifies the configured host (ok/unreachable/unauthorized) and,\nwhen unhealthy, lists other discovered nodes that still accept\nthe current token — safe rebind targets when a node has left the\ncluster or changed address.",
                "produces": [
                    "application/json"
                ],
                "tags": [
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/handlers.BindingDiagnosis"
                                        }
                                    }
                                }
                            ]
    ...
    "definitions": {
        ...
        "handlers.BindingDiagnosis": {
            ...
            "properties": {
                ...
                "configured_url": {
                    "description": "ConfiguredURL echoes the host Nimbus is currently bound to.",
                    "type": "string"
                },
                "detail": {
                    "description": "Detail is a human-readable, banner-ready explanation of State.",
                    "type": "string"
                },
                "state": {
                    "description": "State of the configured host: \"ok\", \"unreachable\", or \"unauthorized\".",
                    "type": "string"
                }
            }
        },
