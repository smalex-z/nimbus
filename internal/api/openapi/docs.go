...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/admin/divergences/{id}": {
            "delete": {
                ...
                "description": "Requires the literal query string ` + "`" + `force=true` + "`" + `. Stops +\ndestroys the PVE VM and removes any local DB row\npointing at the same identity. Idempotent — \"already\ngone\" is treated as success.",
                "produces": [
                    "application/json"
                ],
                "tags": [
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "type": "string",
                        "description": "must equal 'true' to confirm",
                        "name": "force",
                        "in": "query",
                        "required": true
                    }
        ...
        "/admin/divergences/{id}/import": {
            "post": {
                ...
                "description": "Mint a fresh nimbus_id, stamp it onto the Proxmox tag +\ndescription, and insert a vms row. Tier/OS/IP are\nplaceholder values the operator can edit afterwards;\nNimbus doesn't have enough information to infer them.",
                "produces": [
                    "application/json"
                ],
                "tags": [
    ...
    "definitions": {
        ...
        "handlers.resolveResponse": {
            ...
            "properties": {
                "result": {
                    "$ref": "#/definitions/reconciler.ResolveResult"
                }
            }
        },
